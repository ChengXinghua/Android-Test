...
public class Center_activitymanage extends mainDisplayActivity {
...
// TODO Auto-generated method stub
        ...
        this.setContentView(R.layout.center_activitymanage);
        ...
        item1.put("act_publish_time","2017.7.15");
        item1.put("act_condition", "活动待举行");
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, data,
                R.layout.center_am_list, new String[] {
                "act_publish_time",
                "act_condition",
                "playbill",
                "name",
        ...
        ibt1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(Center_activitymanage.this, Center.class);
