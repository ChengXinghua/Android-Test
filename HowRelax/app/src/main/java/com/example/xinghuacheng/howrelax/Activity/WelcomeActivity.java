...
import com.example.xinghuacheng.howrelax.MainActivity;
...
/**
 * Created by Xinghua Cheng on 15/06/2017.
 */
...
public class WelcomeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 判断是否是第一次开启应用
        boolean isFirstOpen = com.example.xinghuacheng.howrelax.util.SharedPreferencesUtil.getBoolean(this, com.example.xinghuacheng.howrelax.util.SharedPreferencesUtil.FIRST_OPEN, true);
        // 如果是第一次启动，则先进入功能引导页
        if (isFirstOpen) {

            Intent intent = new Intent(this, com.example.xinghuacheng.howrelax.Activity.WelcomeGuideActivity.class);
